...
#define NLLS_REGISTER_REGISTER(base_class)                                                                          \
...
#define NLLS_REGISTER_CLASS(base_class, name)                                                                       \
    namespace {                                                                                                     \
    std::shared_ptr<base_class> base_class##name##Creator() {                                                       \
        return std::shared_ptr<base_class>(new name());                                                             \
    }                                                                                                               \
    RegisterRegister##base_class base_class##_##name##_register(#name, base_class##name##Creator);                    \
    }
